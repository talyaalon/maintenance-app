    ...
    tasks: [
        {
            ...
            'Title (EN) *': 'Check AC Filter',
            'Title (HE) (Optional)': 'בדיקת מסנן מזגן',
            'Title (TH) (Optional)': 'ตรวจสอบฟิลเตอร์แอร์',
            'location *': 'Floor 1',
            'frequency *': 'Monthly',
            'date_or_days *': '15',
        ...
        },
        {
            ...
            'Title (EN) *': 'Safety Inspection',
            'Title (HE) (Optional)': 'בדיקת בטיחות',
            'Title (TH) (Optional)': 'ตรวจสอบความปลอดภัย',
            'location *': 'Floor 2',
            'frequency *': 'One-time',
        ...
        },
        {
            ...
            'employee_name_he (Optional)': '',
            'employee_name_th (Optional)': '',
            'Title (EN) *': 'Weekly Fire Exit Check',
            'Title (HE) (Optional)': 'בדיקת יציאת חירום שבועית',
            'Title (TH) (Optional)': 'ตรวจสอบทางออกฉุกเฉินรายสัปดาห์',
            'location *': 'Floor 1',
            'frequency *': 'Weekly',
            'date_or_days *': '1',
            'urgency (Optional)': 'Normal',
        ...
        },
        {
            ...
            'employee_name_he (Optional)': '',
            'employee_name_th (Optional)': '',
            'Title (EN) *': 'Quarterly Boiler Service',
            'Title (HE) (Optional)': 'תחזוקת דוד רבעונית',
            'Title (TH) (Optional)': 'บริการหม้อต้มรายไตรมาส',
            'location *': 'Floor 2',
            'frequency *': 'Quarterly',
