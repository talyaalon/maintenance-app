  ...
  en: [
    {
      ...
      items: [
        ...
        { type: 'p', html: true, text: 'The <strong>My Account</strong> card in the Profile tab is your personal control panel. Use it to set your display language, manage advanced task-automation preferences (Auto-Approve and Skip-Stuck), and configure your notification channels — both Email and LINE alerts.' },
        { type: 'image', filename: 'dm_my_account_settings_card.png', alt: 'My Account Settings Card' },
      ],
    },
    {
    ...
    },
    {
      title: '5. Advanced Tasks — Frequencies, Bulk Actions & Delete Set',
      items: [
        { type: 'p', html: true, text: '<strong>Task Frequencies:</strong> When creating a recurring task you can choose from Daily, Weekly, Monthly, or Quarterly schedules. Each frequency has specific configuration requirements.' },
        { type: 'p', html: true, text: '<strong>Daily frequency:</strong>' },
        { type: 'step', n: 1, text: 'In the task creation form, tap the Frequency picker and select "Daily".' },
        { type: 'step', n: 2, text: 'The schedule defaults to Monday through Friday. Adjust the active days if needed.' },
        { type: 'step', n: 3, text: 'Save the task — it will now repeat on every selected weekday.' },
        { type: 'image', filename: 'freq_daily.png', alt: 'Daily Frequency Setting' },
        { type: 'p', html: true, text: '<strong>Quarterly frequency:</strong> Use this for tasks that need to repeat every three months (e.g. equipment inspections).' },
        { type: 'step', n: 1, text: 'In the task creation form, tap the Frequency picker and select "Quarterly".' },
        { type: 'step', n: 2, text: 'You must pick exactly 4 dates that represent the four recurrence points across the year.' },
        { type: 'step', n: 3, text: 'Confirm your 4 dates and save the task.' },
        ...
        { type: 'step', n: 2, text: 'Tap additional cards to add them to your selection.' },
        { type: 'step', n: 3, text: 'Use the action bar at the bottom to perform bulk operations.' },
        { type: 'step', n: 4, text: 'Choose "Mark Done" to complete all selected tasks, or "Delete" to permanently remove them.' },
        { type: 'image', filename: 'dm_bulk_task_operations.png', alt: 'Bulk Task Operations' },
        { type: 'note', text: 'Delete Set — Critical Warning: When you open a recurring task you will see two delete options. "Delete" removes only this single occurrence. "Delete Set" permanently deletes the ENTIRE recurring series globally — every past, present, and future instance is removed and cannot be recovered.' },
        { type: 'image', filename: 'mgr_delete_set.png', alt: 'Delete Set Button' },
        { type: 'image', filename: 'dm_task_buttons.png', alt: 'Task Action Buttons (Delete / Delete Set)' },
    ...
    },
    {
      ...
      items: [
        { type: 'p', html: true, text: 'When an employee submits a resolution, the task moves to <strong>Waiting Approval</strong>. Open that tab and tap a card to enter the task detail view.' },
        { type: 'image', filename: 'dm_task_overview.png', alt: 'Task Detail Overview' },
        { type: 'p', html: true, text: 'From the task detail view, the employee can select one of the following resolution states before submitting:' },
        { type: 'ul', items: [
          '<strong>Mark as Done</strong> — The task is fully complete. The employee adds notes and optionally a photo as evidence.',
          '<strong>Continue Task</strong> — The employee needs more time and must provide a reason, select a new due date, and optionally attach a photo.',
          '<strong>Stuck Task</strong> — The employee hit a blocker they cannot resolve without managerial intervention (e.g., contractor needed, budget exceeded, safety concern).',
        ]},
        { type: 'image', filename: 'dm_task_buttons.png', alt: 'Task Action Buttons' },
        { type: 'p', html: true, text: '<strong>Continue Task Flow:</strong> When an employee selects "Continue Task", they are shown a form where they must:' },
        { type: 'step', n: 1, text: 'Enter a reason explaining why the task needs more time.' },
        { type: 'step', n: 2, text: 'Select a new due date for the task.' },
        { type: 'step', n: 3, text: 'Optionally attach a photo (e.g., showing work in progress).' },
        { type: 'step', n: 4, text: 'Tap "Submit". The task is rescheduled and returns to the To Do list with the new date.' },
        { type: 'image', filename: 'dm_task_continue_form.png', alt: 'Continue Task Form' },
        { type: 'note', text: 'A "Continue Task" submission does NOT require your approval — the task is automatically rescheduled. You will see the updated due date and reason in the task history.' },
        { type: 'p', html: true, text: '<strong>Stuck Task Flow:</strong> When an employee selects "Stuck Task", they fill out a form describing the blocker. This flags the task for your mandatory review.' },
        { type: 'step', n: 1, text: 'Open the "Waiting Approval" tab — Stuck tasks appear here alongside Done tasks.' },
        { type: 'step', n: 2, text: 'Tap the Stuck task card to read the employee\'s explanation of the blocker.' },
        { type: 'step', n: 3, text: 'Take the necessary external action (arrange a contractor, approve a budget, make a decision).' },
        { type: 'step', n: 4, text: 'Tap "Approve" to close the task once the blocker is resolved, or "Reject" with instructions to reassign it to the employee.' },
        { type: 'image', filename: 'dm_Stuck_Task_window.png', alt: 'Stuck Task Window' },
        { type: 'note', text: 'A Stuck task is frozen — the employee cannot move it forward until you approve or reject it. They receive a LINE notification as soon as you act.' },
        { type: 'p', html: true, text: '<strong>Delete Set — Recurring Tasks:</strong> When reviewing a recurring task, you will see two delete options in the task detail view.' },
        { type: 'ul', items: [
          '<strong>Delete</strong> — Removes only this single occurrence of the recurring task.',
          '<strong>Delete Set</strong> — Permanently deletes the ENTIRE recurring series — every past, present, and future instance is removed and cannot be recovered.',
        ]},
        { type: 'image', filename: 'dm_delete_set.png', alt: 'Delete Set Button' },
        { type: 'note', text: 'WARNING: "Delete Set" is irreversible. Use it only when permanently retiring a task series. To remove a single occurrence, always use "Delete" (single) instead.' },
      ],
    },
    {
    ...
    {
      title: '8. Import / Export Tasks',
      items: [
        { type: 'p', html: true, text: 'The Import/Export feature lets you manage large numbers of tasks efficiently using Excel templates. Export existing tasks for reporting or bulk edits, and import new tasks in bulk.' },
        { type: 'p', html: true, text: '<strong>Exporting Tasks:</strong>' },
        { type: 'step', n: 1, text: 'Open the Tasks tab and tap the Export button (spreadsheet icon) in the toolbar.' },
        { type: 'step', n: 2, text: 'Select the tasks or date range you want to export.' },
        { type: 'step', n: 3, text: 'Tap "Export" to download the Excel file to your device.' },
        { type: 'image', filename: 'dm_task_export_modal.png', alt: 'Task Export Modal' },
        { type: 'p', html: true, text: '<strong>Importing Tasks:</strong>' },
        { type: 'step', n: 1, text: 'Tap the Import button (upload icon) in the Tasks tab toolbar.' },
        { type: 'step', n: 2, text: 'Download and fill in the provided Excel template with your task data.' },
        { type: 'step', n: 3, text: 'Upload the completed file — the system will validate and create all tasks.' },
        { type: 'image', filename: 'dm_task_import_modal.png', alt: 'Task Import Modal' },
        { type: 'tip', text: 'Use an exported file as a template for bulk imports. Ensure all required fields (title, assignee, due date) are filled before uploading.' },
      ],
    },
  ],
  ...
  he: [
    {
      ...
      items: [
        ...
        { type: 'p', html: true, text: 'כרטיס <strong>החשבון שלי</strong> בלשונית הפרופיל הוא לוח הבקרה האישי שלך. השתמש בו להגדרת שפת התצוגה, ניהול העדפות אוטומציית משימות מתקדמות (אישור אוטומטי ודילוג על תקועות), ותצורת ערוצי ההתראות — הן התראות אימייל והן LINE.' },
        { type: 'image', filename: 'dm_my_account_settings_card.png', alt: 'כרטיס הגדרות החשבון שלי' },
      ],
    },
    {
    ...
    },
    {
      title: '5. משימות מתקדמות — תדירויות, פעולות מרובות ומחק סט',
      items: [
        { type: 'p', html: true, text: '<strong>תדירויות משימה:</strong> בעת יצירת משימה חוזרת ניתן לבחור בין יומי, שבועי, חודשי, או רבעוני. לכל תדירות דרישות הגדרה ספציפיות.' },
        { type: 'p', html: true, text: '<strong>תדירות יומית:</strong>' },
        { type: 'step', n: 1, text: 'בטופס יצירת משימה, לחץ על בורר התדירות ובחר "יומי".' },
        { type: 'step', n: 2, text: 'הלוח ברירת המחדל הוא ימים א׳–ה׳. ניתן לשנות את הימים הפעילים לפי הצורך.' },
        { type: 'step', n: 3, text: 'שמור את המשימה — היא תחזור כעת בכל יום חול שנבחר.' },
        { type: 'image', filename: 'freq_daily.png', alt: 'הגדרת תדירות יומית' },
        { type: 'p', html: true, text: '<strong>תדירות רבעונית:</strong> השתמש בזה למשימות שחוזרות כל שלושה חודשים (למשל בדיקות ציוד).' },
        { type: 'step', n: 1, text: 'בטופס יצירת משימה, לחץ על בורר התדירות ובחר "רבעוני".' },
        { type: 'step', n: 2, text: 'עליך לבחור בדיוק 4 תאריכים המייצגים את ארבע נקודות החזרה במהלך השנה.' },
        { type: 'step', n: 3, text: 'אשר את 4 התאריכים ושמור את המשימה.' },
        ...
        { type: 'step', n: 2, text: 'לחץ על כרטיסים נוספים להוספתם לבחירה.' },
        { type: 'step', n: 3, text: 'השתמש בסרגל הפעולות בתחתית לביצוע פעולות מרובות.' },
        { type: 'step', n: 4, text: 'בחר "סמן כהושלם" להשלמת כל המשימות שנבחרו, או "מחק" להסרתן לצמיתות.' },
        { type: 'image', filename: 'dm_bulk_task_operations.png', alt: 'פעולות מרובות על משימות' },
        { type: 'note', text: 'מחק סט — אזהרה חשובה: בעת פתיחת משימה חוזרת, תראה שתי אפשרויות מחיקה. "מחק" מסיר רק את המופע הבודד הזה. "מחק סט" מוחק לצמיתות את כל הסדרה החוזרת באופן גלובלי — כל מופע, עבר, הווה ועתיד, יימחק ואינו ניתן לשחזור.' },
        { type: 'image', filename: 'mgr_delete_set.png', alt: 'כפתור מחק סט' },
        { type: 'image', filename: 'dm_task_buttons.png', alt: 'כפתורי פעולת משימה (מחק / מחק סט)' },
    ...
    },
    {
      ...
      items: [
        { type: 'p', html: true, text: 'כאשר עובד שולח פתרון, המשימה עוברת ל<strong>ממתין לאישור</strong>. פתח את הלשונית הזו ולחץ על כרטיס לכניסה לתצוגת פרטי המשימה.' },
        { type: 'image', filename: 'dm_task_overview.png', alt: 'תצוגת פרטי משימה' },
        { type: 'p', html: true, text: 'מתצוגת פרטי המשימה, העובד יכול לבחור את אחד ממצבי הפתרון הבאים לפני השליחה:' },
        { type: 'ul', items: [
          '<strong>סמן כהושלם</strong> — המשימה הושלמה במלואה. העובד מוסיף הערות ואופציונלית תמונה כראיה.',
          '<strong>המשך משימה</strong> — העובד זקוק לזמן נוסף ועליו לספק סיבה, לבחור תאריך יעד חדש, ואופציונלית לצרף תמונה.',
          '<strong>משימה תקועה</strong> — העובד נתקל בחסם שאינו יכול לפתור ללא התערבות ניהולית (למשל, קבלן נדרש, תקציב חרג, בעיית בטיחות).',
        ]},
        { type: 'image', filename: 'dm_task_buttons.png', alt: 'כפתורי פעולת משימה' },
        { type: 'p', html: true, text: '<strong>זרימת המשך משימה:</strong> כאשר עובד בוחר "המשך משימה", מוצג לו טופס שבו עליו:' },
        { type: 'step', n: 1, text: 'להזין סיבה המסבירה מדוע המשימה זקוקה לזמן נוסף.' },
        { type: 'step', n: 2, text: 'לבחור תאריך יעד חדש למשימה.' },
        { type: 'step', n: 3, text: 'לצרף תמונה אופציונלית (למשל, המציגה עבודה בתהליך).' },
        { type: 'step', n: 4, text: 'ללחוץ "שלח". המשימה מתוזמנת מחדש וחוזרת לרשימת "לביצוע" עם התאריך החדש.' },
        { type: 'image', filename: 'dm_task_continue_form.png', alt: 'טופס המשך משימה' },
        { type: 'note', text: 'שליחת "המשך משימה" אינה דורשת את אישורך — המשימה מתוזמנת מחדש אוטומטית. תוכל לראות את תאריך היעד המעודכן והסיבה בהיסטוריית המשימה.' },
        { type: 'p', html: true, text: '<strong>זרימת משימה תקועה:</strong> כאשר עובד בוחר "משימה תקועה", הוא ממלא טופס המתאר את החסם. פעולה זו מסמנת את המשימה לבדיקתך המנדטורית.' },
        { type: 'step', n: 1, text: 'פתח את לשונית "ממתין לאישור" — משימות תקועות מופיעות כאן לצד משימות שהושלמו.' },
        { type: 'step', n: 2, text: 'לחץ על כרטיס המשימה התקועה לקריאת הסבר העובד על החסם.' },
        { type: 'step', n: 3, text: 'נקוט פעולה חיצונית נדרשת (דאג לקבלן, אשר תקציב, קבל החלטה).' },
        { type: 'step', n: 4, text: 'לחץ "אשר" לסגירת המשימה לאחר פתרון החסם, או "דחה" עם הוראות להקצאה מחדש לעובד.' },
        { type: 'image', filename: 'dm_Stuck_Task_window.png', alt: 'חלון משימה תקועה' },
        { type: 'note', text: 'משימה תקועה קפואה — העובד לא יכול להמשיך עד שתאשר או תדחה אותה. הוא מקבל הודעת LINE ברגע שתפעל.' },
        { type: 'p', html: true, text: '<strong>מחק סט — משימות חוזרות:</strong> בעת בדיקת משימה חוזרת, תראה שתי אפשרויות מחיקה בתצוגת פרטי המשימה.' },
        { type: 'ul', items: [
          '<strong>מחק</strong> — מסיר רק את המופע הבודד הזה של המשימה החוזרת.',
          '<strong>מחק סט</strong> — מוחק לצמיתות את כל הסדרה החוזרת — כל מופע, עבר, הווה ועתיד, יימחק ואינו ניתן לשחזור.',
        ]},
        { type: 'image', filename: 'dm_delete_set.png', alt: 'כפתור מחק סט' },
        { type: 'note', text: 'אזהרה: "מחק סט" הוא בלתי הפיך. השתמש בו רק בעת פרישת סדרת משימות לצמיתות. להסרת מופע בודד, השתמש תמיד ב"מחק" (בודד).' },
      ],
    },
    {
    ...
    {
      title: '8. ייבוא / ייצוא משימות',
      items: [
        { type: 'p', html: true, text: 'תכונת הייבוא/ייצוא מאפשרת לנהל כמויות גדולות של משימות ביעילות באמצעות תבניות Excel. ניתן לייצא משימות קיימות לדיווח או עריכה מרובה, ולייבא משימות חדשות בכמות.' },
        { type: 'p', html: true, text: '<strong>ייצוא משימות:</strong>' },
        { type: 'step', n: 1, text: 'פתח את לשונית המשימות ולחץ על כפתור הייצוא (סמל גיליון) בסרגל הכלים.' },
        { type: 'step', n: 2, text: 'בחר את המשימות או טווח התאריכים לייצוא.' },
        { type: 'step', n: 3, text: 'לחץ "ייצא" להורדת קובץ ה-Excel למכשיר שלך.' },
        { type: 'image', filename: 'dm_task_export_modal.png', alt: 'חלון ייצוא משימות' },
        { type: 'p', html: true, text: '<strong>ייבוא משימות:</strong>' },
        { type: 'step', n: 1, text: 'לחץ על כפתור הייבוא (סמל העלאה) בסרגל הכלים של לשונית המשימות.' },
        { type: 'step', n: 2, text: 'הורד ומלא את תבנית ה-Excel המסופקת עם נתוני המשימות שלך.' },
        { type: 'step', n: 3, text: 'העלה את הקובץ המוכן — המערכת תאמת ותיצור את כל המשימות.' },
        { type: 'image', filename: 'dm_task_import_modal.png', alt: 'חלון ייבוא משימות' },
        { type: 'tip', text: 'השתמש בקובץ מיוצא כתבנית לייבוא מרובה. ודא שכל השדות הנדרשים (כותרת, מקצה, תאריך יעד) מולאו לפני ההעלאה.' },
      ],
    },
  ],
  ...
  th: [
    {
      ...
      items: [
        ...
        { type: 'p', html: true, text: 'การ์ด<strong>บัญชีของฉัน</strong>ในแท็บโปรไฟล์คือแผงควบคุมส่วนตัวของคุณ ใช้เพื่อตั้งค่าภาษาที่แสดง จัดการการตั้งค่าระบบอัตโนมัติขั้นสูง (อนุมัติอัตโนมัติและข้ามงานติดขัด) และกำหนดช่องทางการแจ้งเตือน — ทั้งอีเมลและ LINE' },
        { type: 'image', filename: 'dm_my_account_settings_card.png', alt: 'การ์ดการตั้งค่าบัญชีของฉัน' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        { type: 'p', html: true, text: '<strong>ความถี่งาน:</strong> เมื่อสร้างงานที่เกิดซ้ำ คุณสามารถเลือกรายวัน รายสัปดาห์ รายเดือน หรือรายไตรมาส แต่ละความถี่มีข้อกำหนดการกำหนดค่าเฉพาะ' },
        { type: 'p', html: true, text: '<strong>ความถี่รายวัน:</strong>' },
        { type: 'step', n: 1, text: 'ในแบบฟอร์มสร้างงาน แตะตัวเลือกความถี่และเลือก "รายวัน"' },
        { type: 'step', n: 2, text: 'ตารางเวลาเริ่มต้นเป็นวันจันทร์ถึงศุกร์ ปรับวันที่ใช้งานได้ตามต้องการ' },
        { type: 'step', n: 3, text: 'บันทึกงาน — ขณะนี้งานจะซ้ำทุกวันทำงานที่เลือก' },
        { type: 'image', filename: 'freq_daily.png', alt: 'การตั้งค่าความถี่รายวัน' },
        { type: 'p', html: true, text: '<strong>ความถี่รายไตรมาส:</strong> ใช้สำหรับงานที่ต้องทำซ้ำทุกสามเดือน (เช่น การตรวจสอบอุปกรณ์)' },
        { type: 'step', n: 1, text: 'ในแบบฟอร์มสร้างงาน แตะตัวเลือกความถี่และเลือก "รายไตรมาส"' },
        { type: 'step', n: 2, text: 'คุณต้องเลือกวันที่พอดี 4 วันที่แสดงถึงจุดการเกิดซ้ำสี่จุดตลอดปี' },
        { type: 'step', n: 3, text: 'ยืนยัน 4 วันที่ของคุณและบันทึกงาน' },
        ...
        { type: 'step', n: 2, text: 'แตะการ์ดเพิ่มเติมเพื่อเพิ่มในการเลือก' },
        { type: 'step', n: 3, text: 'ใช้แถบการดำเนินการที่ด้านล่างเพื่อดำเนินการหลายรายการ' },
        { type: 'step', n: 4, text: 'เลือก "ทำเครื่องหมายว่าเสร็จ" เพื่อดำเนินการให้สำเร็จทั้งหมด หรือ "ลบ" เพื่อลบออกอย่างถาวร' },
        { type: 'image', filename: 'dm_bulk_task_operations.png', alt: 'การดำเนินการงานหลายรายการ' },
        { type: 'note', text: 'ลบชุด — คำเตือนสำคัญ: เมื่อคุณเปิดงานที่เกิดซ้ำ คุณจะเห็นตัวเลือกลบสองแบบ "ลบ" ลบเฉพาะการเกิดซ้ำครั้งนี้เท่านั้น "ลบชุด" ลบชุดที่เกิดซ้ำทั้งหมดอย่างถาวรทั่วโลก — ทุกอินสแตนซ์ ทั้งอดีต ปัจจุบัน และอนาคต จะถูกลบและไม่สามารถกู้คืนได้' },
        { type: 'image', filename: 'mgr_delete_set.png', alt: 'ปุ่มลบชุด' },
        { type: 'image', filename: 'dm_task_buttons.png', alt: 'ปุ่มดำเนินการงาน (ลบ / ลบชุด)' },
    ...
    },
    {
      ...
      items: [
        { type: 'p', html: true, text: 'เมื่อพนักงานส่งการแก้ไข งานจะย้ายไปที่ <strong>รออนุมัติ</strong> เปิดแท็บนั้นและแตะการ์ดเพื่อเข้าสู่มุมมองรายละเอียดงาน' },
        { type: 'image', filename: 'dm_task_overview.png', alt: 'มุมมองรายละเอียดงาน' },
        { type: 'p', html: true, text: 'จากมุมมองรายละเอียดงาน พนักงานสามารถเลือกสถานะการแก้ไขต่อไปนี้ก่อนส่ง:' },
        { type: 'ul', items: [
          '<strong>ทำเครื่องหมายว่าเสร็จ</strong> — งานเสร็จสมบูรณ์แล้ว พนักงานเพิ่มบันทึกและแนบรูปภาพเป็นหลักฐานได้ตามต้องการ',
          '<strong>ดำเนินงานต่อ</strong> — พนักงานต้องการเวลาเพิ่มเติมและต้องระบุเหตุผล เลือกวันครบกำหนดใหม่ และแนบรูปภาพได้ตามต้องการ',
          '<strong>งานติดขัด</strong> — พนักงานพบอุปสรรคที่ไม่สามารถแก้ไขได้โดยไม่มีการแทรกแซงจากผู้จัดการ (เช่น ต้องการผู้รับเหมา เกินงบประมาณ ปัญหาความปลอดภัย)',
        ]},
        { type: 'image', filename: 'dm_task_buttons.png', alt: 'ปุ่มดำเนินการงาน' },
        { type: 'p', html: true, text: '<strong>ขั้นตอนดำเนินงานต่อ:</strong> เมื่อพนักงานเลือก "ดำเนินงานต่อ" จะมีฟอร์มปรากฏขึ้นโดยต้อง:' },
        { type: 'step', n: 1, text: 'ระบุเหตุผลที่อธิบายว่าทำไมงานต้องการเวลาเพิ่มเติม' },
        { type: 'step', n: 2, text: 'เลือกวันครบกำหนดใหม่สำหรับงาน' },
        { type: 'step', n: 3, text: 'แนบรูปภาพได้ตามต้องการ (เช่น แสดงงานที่กำลังดำเนินการ)' },
        { type: 'step', n: 4, text: 'แตะ "ส่ง" งานจะถูกกำหนดใหม่และกลับไปยังรายการ "ต้องทำ" พร้อมวันที่ใหม่' },
        { type: 'image', filename: 'dm_task_continue_form.png', alt: 'ฟอร์มดำเนินงานต่อ' },
        { type: 'note', text: 'การส่ง "ดำเนินงานต่อ" ไม่ต้องการการอนุมัติของคุณ — งานจะถูกกำหนดเวลาใหม่โดยอัตโนมัติ คุณจะเห็นวันครบกำหนดที่อัปเดตและเหตุผลในประวัติงาน' },
        { type: 'p', html: true, text: '<strong>ขั้นตอนงานติดขัด:</strong> เมื่อพนักงานเลือก "งานติดขัด" พวกเขาจะกรอกฟอร์มที่อธิบายอุปสรรค ซึ่งจะแจ้งงานสำหรับการตรวจสอบบังคับของคุณ' },
        { type: 'step', n: 1, text: 'เปิดแท็บ "รออนุมัติ" — งานติดขัดจะปรากฏที่นี่พร้อมกับงานที่เสร็จแล้ว' },
        { type: 'step', n: 2, text: 'แตะการ์ดงานติดขัดเพื่ออ่านคำอธิบายของพนักงานเกี่ยวกับอุปสรรค' },
        { type: 'step', n: 3, text: 'ดำเนินการภายนอกที่จำเป็น (จัดหาผู้รับเหมา อนุมัติงบประมาณ ตัดสินใจ)' },
        { type: 'step', n: 4, text: 'แตะ "อนุมัติ" เพื่อปิดงานเมื่อแก้ไขอุปสรรคแล้ว หรือ "ปฏิเสธ" พร้อมคำแนะนำเพื่อมอบหมายใหม่ให้พนักงาน' },
        { type: 'image', filename: 'dm_Stuck_Task_window.png', alt: 'หน้าต่างงานติดขัด' },
        { type: 'note', text: 'งานติดขัดถูกระงับ — พนักงานไม่สามารถดำเนินการต่อได้จนกว่าคุณจะอนุมัติหรือปฏิเสธ พวกเขาจะได้รับการแจ้งเตือน LINE ทันทีที่คุณดำเนินการ' },
        { type: 'p', html: true, text: '<strong>ลบชุด — งานที่เกิดซ้ำ:</strong> เมื่อตรวจสอบงานที่เกิดซ้ำ คุณจะเห็นตัวเลือกลบสองแบบในมุมมองรายละเอียดงาน' },
        { type: 'ul', items: [
          '<strong>ลบ</strong> — ลบเฉพาะการเกิดซ้ำครั้งนี้เท่านั้นของงานที่เกิดซ้ำ',
          '<strong>ลบชุด</strong> — ลบชุดที่เกิดซ้ำทั้งหมดอย่างถาวร — ทุกอินสแตนซ์ ทั้งอดีต ปัจจุบัน และอนาคต จะถูกลบและไม่สามารถกู้คืนได้',
        ]},
        { type: 'image', filename: 'dm_delete_set.png', alt: 'ปุ่มลบชุด' },
        { type: 'note', text: 'คำเตือน: "ลบชุด" ไม่สามารถย้อนกลับได้ ใช้เฉพาะเมื่อต้องการยกเลิกชุดงานอย่างถาวร สำหรับการลบการเกิดซ้ำครั้งเดียว ให้ใช้ "ลบ" (รายเดียว) เสมอ' },
      ],
    },
    {
    ...
    {
      title: '8. นำเข้า / ส่งออกงาน',
      items: [
        { type: 'p', html: true, text: 'ฟีเจอร์นำเข้า/ส่งออกช่วยให้คุณจัดการงานจำนวนมากได้อย่างมีประสิทธิภาพโดยใช้เทมเพลต Excel คุณสามารถส่งออกงานที่มีอยู่สำหรับการรายงานหรือแก้ไขจำนวนมาก และนำเข้างานใหม่จำนวนมากได้' },
        { type: 'p', html: true, text: '<strong>การส่งออกงาน:</strong>' },
        { type: 'step', n: 1, text: 'เปิดแท็บงานและแตะปุ่มส่งออก (ไอคอนสเปรดชีต) ในแถบเครื่องมือ' },
        { type: 'step', n: 2, text: 'เลือกงานหรือช่วงวันที่ที่ต้องการส่งออก' },
        { type: 'step', n: 3, text: 'แตะ "ส่งออก" เพื่อดาวน์โหลดไฟล์ Excel ไปยังอุปกรณ์ของคุณ' },
        { type: 'image', filename: 'dm_task_export_modal.png', alt: 'โมดัลส่งออกงาน' },
        { type: 'p', html: true, text: '<strong>การนำเข้างาน:</strong>' },
        { type: 'step', n: 1, text: 'แตะปุ่มนำเข้า (ไอคอนอัปโหลด) ในแถบเครื่องมือแท็บงาน' },
        { type: 'step', n: 2, text: 'ดาวน์โหลดและกรอกเทมเพลต Excel ที่ให้มาด้วยข้อมูลงานของคุณ' },
        { type: 'step', n: 3, text: 'อัปโหลดไฟล์ที่กรอกครบแล้ว — ระบบจะตรวจสอบและสร้างงานทั้งหมด' },
        { type: 'image', filename: 'dm_task_import_modal.png', alt: 'โมดัลนำเข้างาน' },
        { type: 'tip', text: 'ใช้ไฟล์ที่ส่งออกเป็นเทมเพลตสำหรับการนำเข้าจำนวนมาก ตรวจสอบให้แน่ใจว่าฟิลด์ที่จำเป็นทั้งหมด (ชื่อ ผู้รับมอบหมาย วันกำหนด) ถูกกรอกก่อนอัปโหลด' },
      ],
    },
  ],
};
  ...
  en: [
    {
      title: '1. Login & Navigation',
      items: [
        { type: 'p', html: true, text: 'Log in with the email and password provided by your Department Manager.' },
        ...
        { type: 'p', html: true, text: 'The <strong>Team</strong> tab lists every employee assigned directly to you — their name, role, and contact details. To add or remove team members, contact your Department Manager.' },
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'step', n: 2, text: 'Set priority: Regular or Urgent.' },
  ...
  he: [
    {
      title: '1. כניסה וניווט',
      items: [
        { type: 'p', html: true, text: 'התחבר עם האימייל והסיסמה שסיפק לך מנהל המחלקה.' },
        ...
        { type: 'p', html: true, text: 'לשונית <strong>הצוות</strong> מציגה את כל העובדים המשויכים ישירות אליך — שמם, תפקידם ופרטי הקשר שלהם. להוספה או הסרה של חברי צוות, פנה למנהל המחלקה.' },
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'step', n: 2, text: 'קבע עדיפות: רגילה או דחופה.' },
  ...
  th: [
    {
      title: '1. การเข้าสู่ระบบและการนำทาง',
      items: [
        { type: 'p', html: true, text: 'เข้าสู่ระบบโดยใช้อีเมลและรหัสผ่านที่ผู้จัดการแผนกของคุณให้ไว้' },
        ...
        { type: 'p', html: true, text: 'แท็บ<strong>ทีม</strong>แท็บนี้แสดงรายชื่อพนักงานทุกคนที่ได้รับมอบหมายให้ดูแลคุณโดยตรง ได้แก่ ชื่อ ตำแหน่ง และรายละเอียดการติดต่อ หากต้องการเพิ่มหรือลบสมาชิกในทีม โปรดติดต่อผู้จัดการแผนกของคุณ' },
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'step', n: 2, text: 'กำหนดลำดับความสำคัญ: ปกติ หรือ เร่งด่วน' },
