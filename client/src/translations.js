export const translations = {
  ...
  en: {
    ...
    no_assets: "No assets",
    self_label: "You",
    team_assigned_to_you: "Showing only employees assigned to you",
    ...
    exporting: "Exporting...",
    close: "Close",
    import_update_tab: "Import / Update",
    export_data_tab: "Export Data",
    rows_ready: "rows ready",
    import_success: "Import completed",
    inserted: "added",
    updated: "updated",
    no_fields_available: "All fields selected",
    section_name_categories: "Categories",
    section_name_assets: "Assets",
    section_name_locations: "Locations",
    section_name_managers: "Managers",
    section_name_employees: "Employees",
  ...
  he: {
    ...
    no_employees: "אין עובדים משויכים",
    no_locations: "אין מיקומים",
    no_categories: "אין קטגוריות",
    no_assets: "אין נכסים",
    self_label: "אתה",
    team_assigned_to_you: "מציג רק עובדים המשויכים אליך",
    ...
    exporting: "מייצא...",
    close: "סגור",
    import_update_tab: "ייבוא / עדכון",
    export_data_tab: "ייצוא נתונים",
    rows_ready: "שורות מוכנות",
    import_success: "הייבוא הושלם",
    inserted: "נוספו",
    updated: "עודכנו",
    no_fields_available: "כל השדות נבחרו",
    section_name_categories: "קטגוריות",
    section_name_assets: "נכסים",
    section_name_locations: "מיקומים",
    section_name_managers: "מנהלים",
    section_name_employees: "עובדים",
  ...
  th: {
    ...
    company_name_placeholder: "เช่น Acme Corp",
    company_name_required: "กรุณากรอกชื่อบริษัท",
    company_logo_label: "โลโก้ (ไม่บังคับ)",
    company_id_label: "รหัส",
    company_detail_subtitle: "แดชบอร์ดบริษัท",
    no_companies: "ยังไม่มีบริษัท",
    create_first_company: "สร้างบริษัทแรกของคุณเพื่อเริ่มต้น",
    confirm_delete_company: "ลบบริษัท",
    managers_label: "ผู้จัดการ",
    employees_label: "พนักงาน",
    no_managers: "ไม่มีผู้จัดการที่ได้รับมอบหมาย",
    no_employees: "ไม่มีพนักงานที่ได้รับมอบหมาย",
    no_locations: "ไม่มีสถานที่",
    no_categories: "ไม่มีหมวดหมู่",
    no_assets: "ไม่มีทรัพย์สิน",
    self_label: "คุณ",
    team_assigned_to_you: "แสดงเฉพาะพนักงานที่มอบหมายให้คุณ",
    ...
    close: "ปิด",
    import_update_tab: "นำเข้า / อัปเดต",
    export_data_tab: "ส่งออกข้อมูล",
    rows_ready: "แถวพร้อม",
    import_success: "นำเข้าเสร็จสมบูรณ์",
    inserted: "เพิ่มแล้ว",
    updated: "อัปเดตแล้ว",
    no_fields_available: "เลือกทุกฟิลด์แล้ว",
    section_name_categories: "หมวดหมู่",
    section_name_assets: "สินทรัพย์",
    section_name_locations: "สถานที่",
    section_name_managers: "ผู้จัดการ",
    section_name_employees: "พนักงาน",
